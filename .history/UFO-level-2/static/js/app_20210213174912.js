  ...
  if (dateFilterData.length === 0 && cityFilterData.length === 0 && stateFilterData.length === 0 && countryFilterData.length === 0) {
    buildtable(shapeFilterData)
      ...
      buildtable(countryFilterData)
        ...
        else if (dateFilterData.length === 0 && cityFilterData.length === 0 && stateFilterData.length === 0 && countryFilterData.length === 0) {

}

// filter buton configuration - need to update the 'countryClick' part
